...
<body style="background-color: #f2f2f2;">
	...
	<div class="ui container" style="position: relative; top: 100px;">
		<table class="ui celled striped table">
			<thead>
				<tr>
					<th colspan="2"><i class="fire icon"></i><i class="users icon"></i> 햞eas </th>
					<th colspan="1"><a href="NovaArea" class="ui button blue" style="width:100%;">Cadastrar 햞ea</a></th>
				</tr>
			</thead>
			<tbody>
			<tr>
				<td><strong>햞ea</strong></td>
				<td></td>
				<td> </td>
			</tr>
		<%
		...
		%>
				...
				<tr>
					<td class="collapsing"><i class="fire icon"></i>햞ea <%out.print(lu.get(x).getNumeroIdentificador()); %></td>
